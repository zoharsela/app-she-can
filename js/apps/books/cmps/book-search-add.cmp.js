...
export default {
    ...
    template: `
        <section class="book-add">
                <input class="add-input" type="text" v-model="findVal" placeholder="Find Other Books" @keyup.enter="searchBook"> 
                    <ul class="book-add-list" v-if="googleBookOptions">
                            <template v-for="option in googleBookOptions">
                                <li class="add-book" :key="option.id"> 
                                    ...
                                    <button class="add-btn" @click="addBook(option.id)">+</button>
                                </li>
                            </template>
                        </ul>
                    </section>
